...
async def get_current_user(
    ...
    # Funding Opportunity Intelligence, Phase 2 — this used to eagerly load
    # User.org_context via selectinload; that relationship was removed
    # (see OrgContextDB's docstring in models/db_models.py) since
    # OrgContextDB.user_id is no longer unique, and nothing downstream
    # actually read `current_user.org_context` — grepped before removing.
