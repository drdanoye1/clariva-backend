...
GRANT_TYPES: Dict[str, Dict[str, Any]] = {
    ...
    "sbir": {
        ...
        "sections": [
            ...
            {"id": "commercialization","title": "Commercialization Potential",        "page_limit": 4,  "required": True,  "weight": 0.20},
            {"id": "phase2_plan",      "title": "Phase II Transition Plan",           "page_limit": 2,  "required": False, "weight": 0.10},
            {"id": "team",             "title": "PI & Team Qualifications",           "page_limit": 3,  "required": True,  "weight": 0.15},
    ...
    "sttr": {
        ...
        "sections": [
            ...
            {"id": "tech_merit",       "title": "Technical Merit & Innovation",       "page_limit": 6,  "required": True,  "weight": 0.25},
            {"id": "commercialization","title": "Commercialization Potential",        "page_limit": 4,  "required": True,  "weight": 0.20},
            {"id": "cooperative_rd",   "title": "Cooperative R&D Plan",               "page_limit": 2,  "required": True,  "weight": 0.10},
            {"id": "team",             "title": "PI, Team & Research Institution",    "page_limit": 3,  "required": True,  "weight": 0.15},
            {"id": "facilities",       "title": "Facilities & Resources",             "page_limit": 2,  "required": True,  "weight": 0.08},
            {"id": "budget_narrative", "title": "Budget Justification",               "page_limit": 3,  "required": True,  "weight": 0.05},
            {"id": "references",       "title": "References",                         "page_limit": None,"required": True, "weight": 0.02},
        ],
